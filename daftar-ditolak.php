...
<head>
<meta charset="utf-8">
<title>Daftar Berita Ditolak</title>
...
<div class="tulis-dua">
  <p>
    &nbsp;
      ...
      <h1>Daftar Berita yang Sudah Ditolak</h1>
</div>
<div id="tulis">
  <div class="filter">
    ...
    $result = mysqli_query($connect,"SELECT * FROM berita WHERE status='ditolak'");
    ...
    $query = mysqli_query($connect,"SELECT b.id_berita,b.judul,b.status,b.tanggal, b.isi, b.gambar, u.username,k.daftar_kategori from berita b 
      JOIN user u ON b.id_user=u.iduser JOIN kategori k ON b.id_kategori=k.idkategori WHERE b.status='ditolak' ORDER BY b.id_berita DESC LIMIT $mulai, $halaman");
    $no =$mulai+1;


    while ($data = mysqli_fetch_assoc($query)) {
              $readmore = substr($data['isi'],0, 250);
              echo "<tr>";
              ...
              echo "<td>".$readmore.". . .</td>";
              echo "<td><img src='img/no.jpg' width=20</td>";
