...
<hr>
	<?php
	    ...
	    $result = mysqli_query($connect,"SELECT * FROM berita WHERE id_kategori=4 AND status='diterima'");
	    $total = mysqli_num_rows($result);
	    $pages = ceil($total/$halaman);

          $query = "SELECT b.id_berita,b.judul,b.status,b.tanggal, b.isi, b.gambar, u.username,k.daftar_kategori from berita b JOIN user u ON b.id_user=u.iduser JOIN kategori k ON b.id_kategori=k.idkategori WHERE id_kategori=4 AND status='diterima' ORDER BY b.id_berita DESC LIMIT $mulai, $halaman";
